...
const WEBHOOK_URL =
  ...
  "https://discord.com/api/webhooks/1388855847400116244/cCMVpnKRtGxLUwxPbkKDO97fwEwqP3QduJDE-wqRS4_vXGdEoHeQZPtOLmuv5-aGo3JW";

function getLogColors(type) {
  switch (type.toLowerCase()) {
    case "debug":
      return { type: chalk.green.bold, message: chalk.greenBright };
    case "info":
      return { type: chalk.blue.bold, message: chalk.white };
    case "warn":
      return { type: chalk.yellow.bold, message: chalk.yellowBright };
    case "error":
      return { type: chalk.red.bold, message: chalk.red };
    case "fatal":
      return { type: chalk.bgRed.white.bold, message: chalk.bgRed.white };
    default:
      return { type: chalk.white.bold, message: chalk.white };
  }
}
...
function log(type, message, additionalData = {}) {
  ...
  // Extract response or res info for webhook payload
  ...
  // Filter out res/response from extra data to avoid logging streams
